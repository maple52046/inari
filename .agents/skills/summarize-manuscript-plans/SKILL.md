...
description: >-
  Consolidate plan manuscripts under docs/plans/manuscripts/ into one long-term
  plan and then delete the source drafts. Use only when the user explicitly
  invokes $summarize-manuscript-plans.
---
